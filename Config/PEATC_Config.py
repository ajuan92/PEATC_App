...
'''
PEATC_CONFIG_WINDOW_WIDTH_X = 800
PEATC_CONFIG_WINDOW_HEIGHT_Y = 500

PEATC_CONFIG_DEB_LOG_PATH = "Debug_Log_Output.txt"

PEATC_CONFIG_CURR_OS = "Windows"  # "Linux"
PEATC_CONFIG_TEST_MODE = True # False
...
PEATC_CONFIG_AMP_THRESHOLD = 10 #105
PEATC_CONFIG_TIME_US_PER_SAMPLE = 100
PEATC_CONFIG_EXPECTED_SIGNAL_SAMPLES = 150 #2 ** 12
